...
async def choose_name_anon(message: types.Message, state: FSMContext):
    await message.answer("Напиши свою идею:", reply_markup=types.ReplyKeyboardRemove())
    await Idea.TextAndAnon.set()
...
async def save_name(message: types.Message, state: FSMContext):
    ...
    await message.answer("Напиши свою идею:")
    await Idea.TextAndName.set()
